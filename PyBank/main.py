...
greatest_increase_date = str(csvreader[profit_changes.index(greatest_increase) + 1][0])

# Calculate greatest decrease in profit and corresponding date
greatest_decrease = min(profit_changes)
greatest_decrease_date = str(csvreader[profit_changes.index(greatest_decrease) + 1][0])
